...
export default function HeroSection() {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/21aansh06",
      icon: "github"
    },
    {
      name: "LinkedIn",
          ...
          {skills.map((skill) => (
            <Badge
              ...
              className={cn(
                ...
                skill === "PostgresSQL" && "bg-yellow-500/20 text-yellow-500 hover:bg-yellow-500/30",
                skill === "Tailwind CSS" && "bg-cyan-500/20 text-cyan-500 hover:bg-cyan-500/30",
                skill === "Zustand" && "bg-blue-500/20 text-blue-500 hover:bg-blue-500/30",
                ...
                skill === "Docker" && "bg-sky-500/20 text-sky-500 hover:bg-sky-500/30",
              )}
            >
              {skill}
            </Badge>
