    ...
    <footer className="border-t border-border">
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Aansh Malhotra</h3>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/21aansh06" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <div className="mt-4">
              <a href="mailto:aanshmalhotra49@gmail.com" className="text-muted-foreground hover:text-foreground transition-colors">
                aanshmalhotra49@gmail.com
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} Aansh Malhotra. All rights reserved.</p>
